...
const CategoryCard = ({ title, image, count, active, onClick }) => {
  return (
    <div
      className={`
        flex-shrink-0 
        w-24 h-24           /* الحجم الافتراضي للموبايل */
        sm:w-28 sm:h-28     /* حجم أكبر شوية للشاشات الصغيرة */
        md:w-32 md:h-32     /* الحجم الأصلي للشاشات المتوسطة */
        cursor-pointer transition-all duration-200 rounded-sm border-2
        ${active 
    ...
    >
      <div className="p-2 md:p-3 h-full flex flex-col">
        ...
        <div
          className={`
            w-full h-12 sm:h-14 md:h-16 rounded mb-2 flex items-center justify-center
        ...
        <h3
          className={`
            text-[11px] sm:text-sm font-medium mb-1 text-center
