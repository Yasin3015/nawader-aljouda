  ...
  return (
    ...
    >
      <div className={`absolute inset-0 ${number===2?'bg-[var(--color-primary-layer)] !text-center':"bg-black/60"}  flex flex-col justify-center p-6 text-white`}>
        ...
        <button className={`mt-3 text-sm md:text-base text-[var(--color-soft-primary)] font-medium hover:underline flex items-center justify-center transition-all w-fit cursor-pointer ${number===2&&'mx-auto'}`}>
          {t(buttonKey)}
